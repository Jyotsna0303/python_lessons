...
from boto3.s3.transfer import TransferConfig #used in multipart upload
import requests

bucket_name = "jyotsna-practice"
...
def delete_non_empty_bucket(bucket):
    s3_client = s3 = boto3.resource('s3')  #resoource is a advanced level o bkect mapping for aws
